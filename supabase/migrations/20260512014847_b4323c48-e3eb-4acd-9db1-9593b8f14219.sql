CREATE INDEX IF NOT EXISTS idx_price_snapshots_card_recorded_price
ON public.price_snapshots (card_id, recorded_at DESC, price DESC);

CREATE INDEX IF NOT EXISTS idx_price_snapshots_recorded_card_price
ON public.price_snapshots (recorded_at DESC, card_id, price DESC);
